...
class Groups extends Admin_Controller {
	...
	public function delete($id)
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
            ...
            $this->data['id']         = (int) $group->id;
            $this->data['group_name']  = ! empty($group->name) ? htmlspecialchars($group->name, ENT_QUOTES, 'UTF-8') : NULL;

            /* Load Template */
            $this->template->admin_render('admin/groups/delete', $this->data);
		}
		else
		{
