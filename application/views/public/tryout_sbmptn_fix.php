			...
			<div class="main">
				<?php echo form_open(uri_string(), array('id' => 'form-register', 'class' => 'validate-form')); ?>
					<div class="main-header">
						<?php 
							/*if(!empty($message)){
								echo '<div id="messages"><h4>'.$message.'</h4></div>';
							};*/
						?>
					</div>
					<div class="main-wrap">
						...
						<div class="form-group">
							<?php echo lang('birthday', 'birthday');?>
						...
						<div class="form-group single-select validate-input" data-validate="<?php echo lang('departement').$required;?>">
							<?php echo lang('departement', 'departement').form_dropdown($departement);?>
						</div>
						<div class="form-group single-select validate-input" data-validate="<?php echo lang('choice').$required;?>">
							<?php echo lang('choice', 'choice').form_dropdown($choice);?>
						</div>
						...
						<div class="form-group validate-input" data-validate="<?php echo lang('interest').$required;?>">
							<?php echo lang('interest', 'interest').form_input($interest);?>
						</div>
						<div class="clear"></div>
					</div>
					<div class="action">
