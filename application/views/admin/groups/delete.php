                        ...
                        <div class="col-md-12">
                             <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?php echo sprintf(lang('groups_delete_question'), '<span class="label label-primary">'.$group_name).'</span>';?></h3>
                                </div>
                                <div class="box-body">
                                    <?php echo form_open('admin/groups/delete/'. $id, array('class' => 'form-horizontal', 'id' => 'form-status_user')); ?>
