                             ...
                             <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <?php echo form_open(uri_string(), array('class' => 'form-horizontal', 'id' => 'form-edit_user')); ?>
                                        ...
                                        <div class="form-group">
                                            <?php echo lang('departement', 'departement', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_dropdown($departement);?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <div class="btn-group">
                                                    ...
                                                    <?php echo anchor('admin/tryout', lang('actions_cancel'), array('class' => 'btn btn-default btn-flat btn-action')); ?>
                                                </div>
                                            </div>
                                        </div>
                                    <?php echo form_close();?>
