...
<?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/datatables.net-bs/dataTables.bootstrap.min.css');?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/pace/pace.min.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/admin/main.css'); ?>">
