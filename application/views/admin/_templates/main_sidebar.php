...
<?php if ($admin_prefs['user_panel'] == TRUE): ?>
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <?php //echo get_user_image($user_login['email'], 45, array('class' => "img-circle", 'alt' => "User Image"));?>
                            <img src="<?php echo base_url($avatar_dir . '/default-gravatar.jpg'); ?>" class="img-circle" alt="User Image">
                        </div>
...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="header text-uppercase"><?php echo lang('menu_participants'); ?></li>
                        <li class="<?=active_link_controller('tryout')?>">
                            <a href="<?php echo site_url('admin/tryout'); ?>">
                                <i class="fa fa-book"></i> <span><?php echo lang('menu_tryout'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('mathcomp')?>">
                            <a href="<?php echo site_url('admin/mathcomp'); ?>">
                                <i class="fa fa-graduation-cap"></i> <span><?php echo lang('menu_mathcomp'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('futsal')?>">
                            <a href="<?php echo site_url('admin/futsal'); ?>">
                                <i class="fa fa-futbol-o"></i> <span><?php echo lang('menu_futsal'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('singcomp')?>">
                            <a href="<?php echo site_url('admin/singcomp'); ?>">
                                <i class="fa fa-music"></i> <span><?php echo lang('menu_singcomp'); ?></span>
                            </a>
                        </li>
                        <li class="<?=active_link_controller('baksos')?>">
                            <a href="<?php echo site_url('admin/baksos'); ?>">
                                <i class="fa fa-handshake-o"></i> <span><?php echo lang('menu_baksos'); ?></span>
                            </a>
                        </li>                        
<?php if($admin_menu): ?>
