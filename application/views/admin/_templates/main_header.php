...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    <span class="logo-mini"><b>P</b><?php echo $title_mini; ?></span>
                    <span class="logo-lg"><b>PARSIAL</b> <?php echo $title_lg; ?></span>
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <?php //echo get_user_image($user_login['email'], 25, array('class' => "user-image", 'alt' => "User Image"));?>
                                    <img src="<?php echo base_url($avatar_dir . '/default-gravatar.jpg'); ?>" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo $user_login['username']; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <?php echo get_user_image($user_login['email'], 90, array('class' => "img-circle", 'alt' => "User Image"));?>
