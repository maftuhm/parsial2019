...
?>
                                    ...
                                    <table class="table table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php foreach ($u->groups as $g): echo strtoupper($g->name); endforeach; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table-striped table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo anchor('admin/singcomp/edit/'.$u->id, '<i class="fa fa-edit"></i> '.lang('edit'), array('class' => 'btn btn-primary btn-action')); ?>
                                    ...
                                    <table id="dataTable" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img class="image-pa" src="<?php echo base_url('upload/singcomp/data/'.$p->file_name);?>"></td>
                                                <?php endforeach;?>
            ...
            <?php echo modal_admin(lang('delete'), 'Apakah anda yakin ingin menghapus peserta ini?', anchor('admin/singcomp/delete/'.$u->id, '<i class="fa fa-trash-o"></i> '.lang('delete'), array('class' => 'btn btn-outline')))?>
