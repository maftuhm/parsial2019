                             ...
                             <div class="box">
                                <div class="box-header with-border">
                                    <ul class="box-title nav nav-tabs">
                                        <li class="<?php if($group == 'ikahimatika'){echo 'active';}?>"><a href="<?php echo base_url('admin/futsal/index/ikahimatika');?>"><h5><b>IKAHIMATIKA</b></h5></a></li>
                                        <li class="<?php if($group == 'mahasiswa-umum'){echo 'active';}?>"><a href="<?php echo base_url('admin/futsal/index/mahasiswa-umum');?>"><h5><b>Mahasiswa Umum</b></h5></a></li>
                                        <li class="<?php if($group == 'payment'){echo 'active';}?>"><a href="<?php echo base_url('admin/futsal/index/payment');?>"><h5><b><?php echo lang('payment');?></b></h5></a></li>
                                    </ul>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="tab-pane">
                                        <table id="dataTable" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php $i=1; foreach ($futsal as $u): if ($u->group == str_replace('-', ' ', $group) OR $group == ''):?>
                                                <tr>
                                                    <td><?php echo $i;?></td>
                                                    <td class="name">
                                                        <?php 
                                                            $atts = array('class' => 'url_action','title' => lang('see').' '.$u->name);
                                                            echo anchor('admin/futsal/profile/'.$u->id, $u->name, $atts); 
                                                        ?>
                                                        <div class="actions show-actions">
                                                            <?php 
                                                                echo anchor('admin/futsal/profile/'.$u->id, '<i class="fa fa-user" aria-hidden="true"></i> <span>'.lang('see').'</span>', $atts);
                                                                echo anchor('admin/futsal/edit/'.$u->id, '<i class="fa fa-edit" aria-hidden="true"></i> <span>'.lang('edit').'</span>', 'class="url_action"');
                                                                echo anchor('admin/futsal/delete/'.$u->id, '<i class="fa fa-trash" aria-hidden="true"></i> <span>'.lang('delete').'</span>', 'class="url_action"');
                                                            ?>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td><?php echo strtoupper($u->group);?></td>
                                                    <?php 
                                                    if($u->payment == FALSE):
                                    ...
                                    <div class="tab-pane" id="payment">
                                        <table id="dataTable" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php $i=1; foreach ($futsal as $u):if ($u->payment != FALSE):?>
                                                <tr>
                                                    <td><?php echo $i;?></td>
                                                    <td class="name">
                                                        <?php 
