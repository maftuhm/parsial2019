...
$config['tables']['tryout']          = 'tryout_sbmptn';
$config['tables']['mathcomp']        = 'mathcomp';
$config['tables']['futsal']          = 'futsal';
$config['tables']['singcomp']        = 'singcomp';
$config['tables']['baksos']          = 'baksos';
$config['tables']['par_groups']      = 'participants_groups';
$config['tables']['to_groups']       = 'tryout_sbmptn_groups';
$config['tables']['payment']         = 'payments';
$config['tables']['common_groups']   = 'common_groups';
$config['tables']['format_number']   = 'format_number';
$config['tables']['file']   		 = 'file';
$config['tables']['par']   		 	 = 'participants';
 ...
 */
$config['site_title']                 = "Pendaftaran PARSIAL HIMATIKA";       // Site Title, example.com
